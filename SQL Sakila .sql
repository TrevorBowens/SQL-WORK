...
SELECT f.title AS TITLE, COUNT(r.rental_date)
FROM film AS f
JOIN Inventory AS I
...
-- To access the GENRES View right click on sakila and choose schema inspector. Select views and click on alter view and the code appears.
